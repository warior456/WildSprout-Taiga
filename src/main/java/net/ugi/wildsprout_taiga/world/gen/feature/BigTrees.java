...
import net.ugi.wildsprout_taiga.world.gen.feature.spruce_trees.BigPine1;
import net.ugi.wildsprout_taiga.world.gen.feature.spruce_trees.BigSpruce1;
import net.ugi.wildsprout_taiga.world.gen.feature.spruce_trees.BigSpruce2;
import net.ugi.wildsprout_taiga.world.gen.feature.spruce_trees.BigSpruce3;

public class BigTrees extends Feature<DefaultFeatureConfig> {

    public BigTrees(Codec<DefaultFeatureConfig> configCodec) {
        super(configCodec);
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        if (r < 0.25) {
            return BigSpruce1.generate(context, center);
        } else if (r < 0.50) {
            return BigSpruce2.generate(context,center);
        } else if (r < 0.75){
            return BigSpruce3.generate(context,center);
        } else {
            return BigPine1.generate(context, center);
        }
    }
}
