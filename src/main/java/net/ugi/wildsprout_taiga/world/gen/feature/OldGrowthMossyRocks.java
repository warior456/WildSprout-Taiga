...
public class OldGrowthMossyRocks extends Feature<DefaultFeatureConfig> {

    public OldGrowthMossyRocks(Codec<DefaultFeatureConfig> configCodec) {
        super(configCodec);
    }
    ...
    public void generateRock(StructureWorldAccess structureWorldAccess, Random random, BlockPos center, BlockState block, BlockState slab){
        ...
        double radius = biased_random_linear(random, 1, 3);
