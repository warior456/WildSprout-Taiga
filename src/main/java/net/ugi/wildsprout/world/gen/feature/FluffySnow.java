...
public class FluffySnow extends Feature<DefaultFeatureConfig> {
    ...
    protected boolean canPlaceAt(StructureWorldAccess world, BlockPos pos) {
        ...
        if (blockState.isIn(ModTags.Blocks.OVERRIDE_SNOW_LAYER_CANNOT_SURVIVE_ON) /*&& WildSproutTaiga.CONFIG.SnowOnIceEnabled && WildSproutPlains.CONFIG.SnowyPlainsEnabled*/) {
